...
const ServicePage: React.FC = () => {
  ...
  const detail = landingContent.serviceDetails.find((item) => item.slug === serviceSlug);
  ...
  if (!detail) {
    return (
      <div className="min-h-screen font-sans text-slate-100 bg-slate-950 pt-16">
        <Navbar />
        <main>
          <Section id="service-not-found" bg="white">
      ...
      <main>
        <section className="relative bg-slate-950 overflow-hidden py-16 sm:py-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center page-load">
              <p className="text-sm uppercase tracking-wider text-slate-400 page-load-item">Leistungen</p>
              <h1 className="mt-2 text-4xl font-extrabold text-slate-100 sm:text-5xl page-load-item">{detail.title}</h1>
              <p className="mt-4 text-lg text-slate-300 page-load-item">{detail.subtitle}</p>
        ...
        <Section id="service-detail" bg="gray">
        ...
        <Section id="service-cta" bg="white">
