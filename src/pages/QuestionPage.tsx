  ...
  return (
    <div className="min-h-screen font-sans text-slate-100 bg-slate-950 pt-16">
      ...
      <main>
        ...
        <section className="relative bg-slate-950 overflow-hidden py-16 sm:py-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center page-load">
              <p className="text-sm uppercase tracking-wider text-slate-400 page-load-item">Fragen</p>
              <h1 className="mt-2 text-4xl font-extrabold text-slate-100 sm:text-5xl page-load-item">Eine Frage stellen</h1>
              <p className="mt-4 text-lg text-slate-300 page-load-item">Sie haben eine Frage zu unseren Leistungen? Wir antworten Ihnen schnellstmöglich.</p>
        ...
        {/* Question Form */}
        <Section id="question-form" bg="gray">
          <div className="max-w-2xl mx-auto">
            <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-6 sm:p-8 shadow-lg glow-panel stagger-reveal">
              <h3 className="text-xl font-bold text-slate-100 mb-2">Ihre Frage an uns</h3>
              <p className="text-slate-300 text-sm mb-6">
                Beschreiben Sie Ihre Frage und wir melden uns so schnell wie möglich bei Ihnen per E-Mail.
              </p>
              ...
              {formStatus === 'success' ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-slate-300">Ihre Frage wurde erfolgreich gesendet. Wir antworten Ihnen in Kürze.</p>
                  <button
                ...
                <form onSubmit={handleQuestionSubmit} className="space-y-5">
                  <div>
                    <label htmlFor="q-name" className="block text-sm font-medium text-slate-200">Name</label>
                    <input
                      type="text"
                      name="name"
                      id="q-name"
                  ...
                  <div>
                    <label htmlFor="q-email" className="block text-sm font-medium text-slate-200">E-Mail</label>
                    <input
                      type="email"
                      name="email"
                      id="q-email"
                  ...
                  <div>
                    <label htmlFor="q-question" className="block text-sm font-medium text-slate-200">Ihre Frage</label>
                    <textarea
                      id="q-question"
                      name="question"
                      rows={5}
                  ...
                  <div>
                    ...
                    >
                      {formStatus === 'submitting' ? 'Sende...' : 'Frage absenden'}
                    </button>
                  </div>
                  {formError ? (
                  ...
                  <p className="text-xs text-slate-400 mt-4 text-center">
                    Mit dem Absenden werden Ihre Angaben zur Bearbeitung Ihrer Frage verarbeitet. Details finden Sie in der Datenschutzerklärung.
                  </p>
                </form>
              )}
            </div>
        ...
        {/* CTA */}
        <Section id="question-cta" bg="white">
          <div className="text-center stagger-reveal">
            <h2 className="text-3xl font-extrabold text-slate-100">Direkt ein Projekt starten?</h2>
            <p className="mt-4 text-slate-300">Wenn Sie bereit sind, kontaktieren Sie uns direkt für eine Projektanfrage.</p>
            <Link
              to="/kontakt"
